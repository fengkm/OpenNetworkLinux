...
static sysi_onie_vpd_t __tlv_vpd_info[SYSI_ONIE_TYPE_SUPPORT_NUM] = {
    {
        ...
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/product_name"
    },
    {
        TLV_CODE_PART_NUMBER,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/part_number"
    },
    {
        TLV_CODE_SERIAL_NUMBER,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/serial_number"
    },
    {
        TLV_CODE_MAC_BASE,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/base_mac_address"
    },
    {
        TLV_CODE_MANUF_DATE,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/manufacture_date"
    },
    {
        TLV_CODE_DEVICE_VERSION,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/device_version"
    },
    {
        TLV_CODE_LABEL_REVISION,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/label_revision"
    },
    {
        TLV_CODE_PLATFORM_NAME,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/platform_name"
    },
    {
        TLV_CODE_ONIE_VERSION,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/onie_version"
    },
    {
        TLV_CODE_MAC_SIZE,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/mac_addresses"
    },
    {
        TLV_CODE_MANUF_NAME,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/manufacturer"
    },
    {
        TLV_CODE_MANUF_COUNTRY,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/country_code"
    },
    {
        TLV_CODE_VENDOR_NAME,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/vendor_name"
    },
    {
        TLV_CODE_DIAG_VERSION,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/diag_version"
    },
    {
        TLV_CODE_SERVICE_TAG,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/service_tag"
    },
    {
        TLV_CODE_VENDOR_EXT,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/vendor_ext"
    },
    {
        TLV_CODE_CRC_32,
        "/sys/class/eeprom/x86_64_ufispace_s9700_23d_onie_syseeprom/crc32"
    }
};
