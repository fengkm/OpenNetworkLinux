...
static int update_psui_fru_info(int local_id, onlp_psu_info_t* info)
{
    ...
    if (local_id == ONLP_PSU_1) {
        ret = onlp_file_read(data, sizeof(data), &data_len, "/sys/bus/i2c/devices/58-0050/eeprom");
    } else if (local_id == ONLP_PSU_2) {
        ret = onlp_file_read(data, sizeof(data), &data_len, "/sys/bus/i2c/devices/57-0050/eeprom");
    } else {
...
static int update_psui_iout_info(int local_id, onlp_psu_info_t* info)
{
    ...
    if (local_id == ONLP_PSU_1) {
        psu_reg_value = onlp_i2c_readw(58, 0x58, 0x8C, ONLP_I2C_F_FORCE);
    } else if (local_id == ONLP_PSU_2) {
        psu_reg_value = onlp_i2c_readw(57, 0x58, 0x8C, ONLP_I2C_F_FORCE);
    } else {
        AIM_LOG_ERROR("unknown PSU id (%d), func=%s\n", local_id, __FUNCTION__);
        return ONLP_STATUS_E_PARAM;
    }
...
static int update_psui_iin_info(int local_id, onlp_psu_info_t* info)
{
    ...
    if (local_id == ONLP_PSU_1) {
        psu_reg_value = onlp_i2c_readw(58, 0x58, 0x89, ONLP_I2C_F_FORCE);
    } else if (local_id == ONLP_PSU_2) {
        psu_reg_value = onlp_i2c_readw(57, 0x58, 0x89, ONLP_I2C_F_FORCE);
    } else {
        AIM_LOG_ERROR("unknown PSU id (%d), func=%s\n", local_id, __FUNCTION__);
        return ONLP_STATUS_E_PARAM;
    }
...
static int update_psui_pout_info(int local_id, onlp_psu_info_t* info)
{
    ...
    if (local_id == ONLP_PSU_1) {
        psu_reg_value = onlp_i2c_readw(58, 0x58, 0x96, ONLP_I2C_F_FORCE);
    } else if (local_id == ONLP_PSU_2) {
        psu_reg_value = onlp_i2c_readw(57, 0x58, 0x96, ONLP_I2C_F_FORCE);
    } else {
        AIM_LOG_ERROR("unknown PSU id (%d), func=%s\n", local_id, __FUNCTION__);
        return ONLP_STATUS_E_PARAM;
    }
...
static int update_psui_pin_info(int local_id, onlp_psu_info_t* info)
{
    ...
    if (local_id == ONLP_PSU_1) {
        psu_reg_value = onlp_i2c_readw(58, 0x58, 0x97, ONLP_I2C_F_FORCE);
    } else if (local_id == ONLP_PSU_2) {
        psu_reg_value = onlp_i2c_readw(57, 0x58, 0x97, ONLP_I2C_F_FORCE);
    } else {
        AIM_LOG_ERROR("unknown PSU id (%d), func=%s\n", local_id, __FUNCTION__);
        return ONLP_STATUS_E_PARAM;
    }
...
static int update_psui_vout_info(int local_id, onlp_psu_info_t* info)
{
    ...
    if (local_id == ONLP_PSU_1) {
        n_value = onlp_i2c_readb(58, 0x58, 0x20, ONLP_I2C_F_FORCE);
        v_value = onlp_i2c_readw(58, 0x58, 0x8B, ONLP_I2C_F_FORCE);
    } else if (local_id == ONLP_PSU_2) {
        n_value = onlp_i2c_readb(57, 0x58, 0x20, ONLP_I2C_F_FORCE);
        v_value = onlp_i2c_readw(57, 0x58, 0x8B, ONLP_I2C_F_FORCE);
    } else {
        AIM_LOG_ERROR("unknown PSU id (%d), func=%s\n", local_id, __FUNCTION__);
        return ONLP_STATUS_E_PARAM;
    }
...
static int update_psui_vin_info(int local_id, onlp_psu_info_t* info)
{
    ...
    if (local_id == ONLP_PSU_1) {
        psu_reg_value = onlp_i2c_readw(58, 0x58, 0x88, ONLP_I2C_F_FORCE);
    } else if (local_id == ONLP_PSU_2) {
        psu_reg_value = onlp_i2c_readw(57, 0x58, 0x88, ONLP_I2C_F_FORCE);
    } else {
        AIM_LOG_ERROR("unknown PSU id (%d), func=%s\n", local_id, __FUNCTION__);
        return ONLP_STATUS_E_PARAM;
    }
