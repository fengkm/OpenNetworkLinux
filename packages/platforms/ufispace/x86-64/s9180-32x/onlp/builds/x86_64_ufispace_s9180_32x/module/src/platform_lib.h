...
enum onlp_thermal_id {
    ...
    ONLP_THERMAL_CPU3      = 6,
    ONLP_THERMAL_CPU4      = 7,
    ONLP_THERMAL_CPU_BOARD = 8,
    ONLP_THERMAL_PSU1_NEAR = 9,
    ONLP_THERMAL_PSU2_NEAR = 10,
    ONLP_THERMAL_QSFP_NEAR = 11,
    ONLP_THERMAL_PSU1_1    = 12,
    ONLP_THERMAL_PSU1_2    = 13,
    ONLP_THERMAL_PSU2_1    = 14,
    ONLP_THERMAL_PSU2_2    = 15, 
