...
static int qsfp_port_lpmode_gpio_index_array[QSFP_PORT_NUM] = { 417, 416, 419, 418, 421, \
                                                                420, 423, 422, 425, 424, \
                                                                427, 426, 429, 428, 431, \
                                                                430, 401, 400, 403, 402, \
                                                                405, 404, 407, 406, 409, \
...
static int qsfp_port_reset_gpio_index_array[QSFP_PORT_NUM] =  { 385, 384, 387, 386, 389, \
                                                                388, 391, 390, 393, 392, \
                                                                395, 394, 397, 396, 399, \
                                                                398, 369, 368, 371, 370, \
                                                                373, 372, 375, 374, 377, \
...
static int qsfp_port_eeprom_bus_id_array[QSFP_PORT_NUM] = { 10,  9, 12, 11, 14, \
                                                            13, 16, 15, 18, 17, \
                                                            20, 19, 22, 21, 24, \
                                                            23, 26, 25, 28, 27, \
                                                            30, 29, 32, 31, 34, \
